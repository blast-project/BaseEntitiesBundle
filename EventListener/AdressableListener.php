...
class AdressableListener
{
    public function loadClassMetadata(LoadClassMetadataEventArgs $eventArgs)
    {
        ...
        if (!array_key_exists('Librinfo\BaseEntitiesBundle\Entity\Interfaces\AdressableInterface', $metadata->getReflectionClass()->getInterfaces()))
            return;
